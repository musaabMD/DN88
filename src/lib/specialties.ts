...
const RESPIRATORY_DISORDERS_TOPICS = [
  "Acute aspiration",
  "Acute asthma exacerbation in adults",
  "Acute asthma exacerbation in children",
  "Acute bronchitis",
...
const PAEDIATRICS_AND_ADOLESCENT_MEDICINE_TOPICS = [
  "Abetalipoproteinaemia",
  "Absence seizures",
  "Abusive head trauma in infants and young children",
  "Acne vulgaris",
...
const OBSTETRICS_AND_GYNAECOLOGY_TOPICS = [
  "Abnormal uterine bleeding",
  "Acute cystitis",
  "Adenomyosis",
  "Antiphospholipid syndrome",
...
const INTERNAL_MEDICINE_TOPICS = [
  "Abdominal aortic aneurysm",
  "Abetalipoproteinaemia",
  "Absence seizures",
  "Acanthosis nigricans",
...
const INFECTIOUS_DISEASES_TOPICS = [
  "Actinomycosis",
  "Acute aspiration",
  "Acute bronchitis",
  "Acute otitis media",
...
const HOSPITAL_MEDICINE_TOPICS = [
  "Abdominal aortic aneurysm",
  "Abdominal compartment syndrome",
  "Abusive head trauma in infants and young children",
  "Accidental hypothermia",
...
const GASTROENTEROLOGY_AND_HEPATOLOGY_TOPICS = [
  "Achalasia",
  "Achlorhydria",
  "Acute appendicitis",
  "Acute cholangitis",
...
export const SPECIALTY_TOPIC_GROUPS: Array<{
  ...
  },
  {
    ...
    topics: topicsFor("Respiratory disorders", [...RESPIRATORY_DISORDERS_TOPICS]),
  },
  {
    specialty: "Psychiatry",
    topics: topicsFor("Psychiatry", [...PSYCHIATRY_TOPICS]),
  },
  {
    specialty: "Primary care",
    topics: topicsFor("Primary care", [...PRIMARY_CARE_TOPICS]),
  },
  {
    specialty: "Palliative care",
    topics: topicsFor("Palliative care", [...PALLIATIVE_CARE_TOPICS]),
  },
  {
    specialty: "Paediatrics and adolescent medicine",
    topics: topicsFor("Paediatrics and adolescent medicine", [
      ...PAEDIATRICS_AND_ADOLESCENT_MEDICINE_TOPICS,
    ]),
  },
  {
  ...
  {
    specialty: "Oncology",
    topics: topicsFor("Oncology", [...ONCOLOGY_TOPICS]),
  },
  {
  ...
  },
  {
    ...
    topics: topicsFor("Neurosurgery", [...NEUROSURGERY_TOPICS]),
  },
  {
    specialty: "Neurology",
  ...
  },
  {
    ...
    topics: topicsFor("Internal medicine", [...INTERNAL_MEDICINE_TOPICS]),
  },
  {
    specialty: "Infectious diseases",
    topics: topicsFor("Infectious diseases", [...INFECTIOUS_DISEASES_TOPICS]),
  },
  {
  ...
  {
    specialty: "Genetics",
    topics: topicsFor("Genetics", [...GENETICS_TOPICS]),
  },
  {
    specialty: "General surgery",
    topics: topicsFor("General surgery", [...GENERAL_SURGERY_TOPICS]),
  },
  {
    specialty: "Gastroenterology and hepatology",
    topics: topicsFor("Gastroenterology and hepatology", [
      ...GASTROENTEROLOGY_AND_HEPATOLOGY_TOPICS,
    ]),
  },
];
