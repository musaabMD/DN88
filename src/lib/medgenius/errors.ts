...
const GENERIC: Record<string, string> = {
  ...
  auth: "Sign in to use this feature.",
  default: "Something went wrong. Please try again.",
};

export function sanitizeUserError(message: string, kind: keyof typeof GENERIC = "default"): string {
  ...
  if (/Sign in required|Not authenticated|AUTH_REQUIRED/i.test(trimmed)) {
    return GENERIC.auth;
  }
