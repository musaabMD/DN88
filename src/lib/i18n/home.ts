...
const en = {
  ...
  noQuestionsExtracted:
    "No questions were extracted from this file. MCQs are generated by AI after the PDF is parsed — tap Extract MCQs below.",
  extractMcqs: "Extract MCQs",
  extractingMcqs: "Extracting MCQs…",
  extractMcqsStarted: "MCQ extraction started — questions will appear shortly.",
...
const ar = {
  ...
  noQuestionsExtracted:
    "لم تُستخرج أسئلة من هذا الملف. تُولَّد الأسئلة بالذكاء الاصطناعي بعد parse الملف — اضغط استخراج الأسئلة أدناه.",
  extractMcqs: "استخراج الأسئلة",
  extractingMcqs: "جاري استخراج الأسئلة…",
  extractMcqsStarted: "بدأ استخراج الأسئلة — ستظهر قريباً.",
  readSections: "أقسام",
  readPdf: "PDF",
